...
function renderLicenseBadge(license) {
  return license ? `<p><img src="https://img.shields.io/badge/License-${license}-green" alt="license badge"></p>` : ""; 
}
...
function renderLicenseLink(license) {
  const links = {
    ...
    'BSD 2-Clause "Simplified" or "Revised" license': 'https://opensource.org/licenses/BSD-2-Clause',
